...
export const projects = [
		...
		techStack: ["Unity 3D", "C#", "Combat System", "Simple AI", "Scriptable Objects","Rider"],
		description: "A 3D Souls-like combat system in Unity, where I focused on building a clean, optimized, and modular player system with solid architecture. For example, you can set and customize player combos through Scriptable Objects. (Team of 1, 3 weeks)",
		ctaText: "Video →",
	...
	},
	{
		...
		description: "Mini engine built in C++ with OpenGL showcasing real-time lighting. Features day/night cycle, ambient light, dynamic flashlight, and procedural scene generation.",
		ctaText: "Git Hub →",
		ctaLink: "https://github.com/NahuelAparicio10/OpenGL_MiniEngine",
		icon: visual_studio,
		image:"/images/projects/engine_spotlight.png"
	},
	{
	...
	},
	{
		...
		icon: visual_studio,
		image: "/images/projects/ConsoleShooter.png"
	},
];